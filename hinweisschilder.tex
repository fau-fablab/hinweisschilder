...
% Zum Ergänzen neuer Werkzeuge den Tool-Namen (https://fablab.fau.de/tool/TOOLNAME) in generate-qr.py bei "maschinen" eintragen und 'make' ausführen
\newcommand{\linkMitQR}[1]{\includegraphics[width=3cm]{./#1.png} \\ \web{https://fablab.fau.de/tool/#1}}
...
\schild{gelb}{Lasercutter LTT iLaser}
	{Benutzung nur mit Einweisung\\ \smallskip \small (Unterschrift auf Einweisungsliste speziell für dieses Gerät)}{Bei Interesse frage einfach einen Betreuer!
...
\schild{rot}{Spectrumanalyzer Siglent SSA3021X}
	{Benutzung nur nach Rücksprache.}
	{\textbf{Achtung: ESD gefährdet!} \\ Im Moment gibt es leider noch keine Einweisung zu diesem Gerät. Bitte sprich mit einem Betreuer. (s. u.)}
